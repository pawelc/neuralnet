--Exercise 2. Implement Sejnowski's covariance rule to perform clustering of
...
local function buildModel()
  ...
  seq:addLayer(MatrixAggregateLayer.new(1):                  
                  ...
                  setAdjustParamsFun(AdjustParamsFunctions.createSejnowskiCovarianceRuleAdjustParamsFun(opt.learning_rate))
                  )                 
